...
the wild type atomic pdb files. For a reverse mutant, the wildtype is the forward mutant.')
...
@click.option('--rev_mut_pdb',required=False, is_flag=True, help='Set this option \
